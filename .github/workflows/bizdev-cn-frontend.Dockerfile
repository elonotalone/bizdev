...
# 公安联网备案号。2026-08-27 平台状态有效；无参数构建也必须标上。
ARG NEXT_PUBLIC_OCEANLEO_POLICE_BEIAN=粤公网安备44030002016192号
ENV NEXT_PUBLIC_OCEANLEO_POLICE_BEIAN=${NEXT_PUBLIC_OCEANLEO_POLICE_BEIAN}
ARG NEXT_PUBLIC_OCEANLEO_POLICE_BEIAN_CODE=44030002016192
