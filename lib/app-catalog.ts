...
// 形状取 `@oceanleo/ui` 的共享契约，不再手写一份。手写那份把 `artifactType` 钉死成
// 字面量 `"document"`，而本站 position 4 那 19 个槽位已经换成真 pptx（`deck`）——
// 钉死的字面量会让「回填成注册表的真实形态」通不过 typecheck，等于逼人把错的形态留着。
const TEMPLATES: Record<string, NonNullable<GoalApp["templates"]>> = {
  "inquiry-reply": [
      {
      ...
      },
      {
        ...
        title: "产品推介幻灯片 · 金箔典雅风",
        summary: "产品推介版式：核心卖点、关键参数、适用场景与选型建议。",
        tags: ["幻灯片", "产品推介", "金箔典雅风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/greenfood-ginkgo/cover.webp",
        artifactId: "00e90e05-024d-4294-8617-c40160019342",
        artifactType: "deck",
      },
  ],
  "complaint-reply": [
      ...
      },
      {
        ...
        title: "客户服务幻灯片 · 金箔典雅风",
        summary: "售后服务版式：响应时效、处理流程、补偿口径与本地化支持。",
        tags: ["幻灯片", "客户服务", "金箔典雅风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/rural-ginkgo/cover.webp",
        artifactId: "67f4699c-45f2-424c-b1e0-42dab27e46df",
        artifactType: "deck",
      },
  ],
  "whatsapp-reply": [
      ...
      },
      {
        ...
        title: "商务方案幻灯片 · 古典航海图风",
        summary: "商务方案版式：范围、阶梯报价、付款条件与交付节奏。",
        tags: ["幻灯片", "商务方案", "古典航海图风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/route-meridian/cover.webp",
        artifactId: "e51ff790-106e-4503-bf19-cf7c972be2d2",
        artifactType: "deck",
      },
  ],
  "negotiation-reply": [
      ...
      },
      {
        ...
        summary: "商务方案版式：范围、阶梯报价、付款条件与交付节奏。",
        tags: ["幻灯片", "商务方案", "地产建筑风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/interior-glamour/cover.webp",
        artifactId: "dfcdb352-5233-41b3-847a-fc217c39f868",
        artifactType: "deck",
      },
  ],
  "cold-email": [
      ...
      },
      {
        ...
        title: "公司介绍幻灯片 · 金箔典雅风",
        summary: "公司介绍版式：产能、资质、质量体系与合作方式一次说清。",
        tags: ["幻灯片", "公司介绍", "金箔典雅风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/heritage-ginkgo/cover.webp",
        artifactId: "280b6b87-f5a8-4b8d-a412-26709d292386",
        artifactType: "deck",
      },
  ],
  "reactivate-email": [
      ...
      },
      {
        ...
        summary: "公司介绍版式：产能、资质、质量体系与合作方式一次说清。",
        tags: ["幻灯片", "公司介绍", "手账涂鸦风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/drinks-sketch/cover.webp",
        artifactId: "8760a85e-c71e-4e72-ba9d-10eaf6e66ef8",
        artifactType: "deck",
      },
  ],
  "exhibition-invite": [
      ...
      },
      {
        ...
        title: "公司介绍幻灯片 · 水磨石生活风",
        summary: "公司介绍版式：产能、资质、质量体系与合作方式一次说清。",
        tags: ["幻灯片", "公司介绍", "水磨石生活风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/housekeeping-terrazzo/cover.webp",
        artifactId: "4e54787c-fbf0-4beb-805f-4be3fee9ee73",
        artifactType: "deck",
      },
  ],
  "product-intro-letter": [
      ...
      },
      {
        ...
        summary: "产品推介版式：核心卖点、关键参数、适用场景与选型建议。",
        tags: ["幻灯片", "产品推介", "竞速光影风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/pet-mahogany/cover.webp",
        artifactId: "bfceb19e-ab5f-477c-ba26-086cb9f24676",
        artifactType: "deck",
      },
  ],
  "company-research": [
      ...
      },
      {
        ...
        title: "市场分析幻灯片 · 黑白商务风",
        summary: "市场与竞品分析版式：需求特征、竞争格局、准入要求与进入建议。",
        tags: ["幻灯片", "市场分析", "黑白商务风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/research-alabaster/cover.webp",
        artifactId: "277b85a5-f0f4-4b80-8e44-1eed7c79f18e",
        artifactType: "deck",
      },
  ],
  "market-entry": [
      ...
      },
      {
        ...
        summary: "市场与竞品分析版式：需求特征、竞争格局、准入要求与进入建议。",
        tags: ["幻灯片", "市场分析", "白板手绘风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/vocational-whiteboard/cover.webp",
        artifactId: "8a98ed9c-c836-4fa8-a4fb-bc04a1458d06",
        artifactType: "deck",
      },
  ],
  "customer-profile": [
      ...
      },
      {
        ...
        summary: "市场与竞品分析版式：需求特征、竞争格局、准入要求与进入建议。",
        tags: ["幻灯片", "市场分析", "落日剪影风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/citytour-sunset/cover.webp",
        artifactId: "7b4a3092-2026-4e9e-a46f-58613525cb69",
        artifactType: "deck",
      },
  ],
  "competitor-report": [
  ...
  "selling-points": [
      ...
      },
      {
        ...
        summary: "产品推介版式：核心卖点、关键参数、适用场景与选型建议。",
        tags: ["幻灯片", "产品推介", "暖调剪纸风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/recruit-amber/cover.webp",
        artifactId: "3b4768fe-08e4-4c6f-9e70-1235901b96a7",
        artifactType: "deck",
      },
  ],
  "pricing-strategy": [
      ...
      },
      {
        ...
        summary: "商务方案版式：范围、阶梯报价、付款条件与交付节奏。",
        tags: ["幻灯片", "商务方案", "暖调剪纸风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/preschool-amber/cover.webp",
        artifactId: "f8a02738-2b5c-40c9-9b6e-b0dc13ebca8c",
        artifactType: "deck",
      },
  ],
  "trade-translate": [
      ...
      },
      {
        ...
        summary: "售后服务版式：响应时效、处理流程、补偿口径与本地化支持。",
        tags: ["幻灯片", "客户服务", "黑色电影风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/film-noir/cover.webp",
        artifactId: "429ad837-60e6-43a7-a5d4-cd0dd3f508fd",
        artifactType: "deck",
      },
  ],
  "term-localize": [
      ...
      },
      {
        ...
        summary: "售后服务版式：响应时效、处理流程、补偿口径与本地化支持。",
        tags: ["幻灯片", "客户服务", "黑白商务风"],
        previewUrl: "https://oceanleo-assets.oss-cn-guangzhou.aliyuncs.com/assets/ppt/decks/pharma-alabaster/cover.webp",
        artifactId: "126156f8-8a41-4c21-a0c0-45626403bd01",
        artifactType: "deck",
      },
  ],
  "multilang-notice": [
